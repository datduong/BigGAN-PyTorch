...
# --time=1:00:00 --gres=gpu:p100:4 --mem=20g --cpus-per-task=32 
# sbatch --partition=gpu --time=2-12:00:00 --gres=gpu:p100:4 --mem=48g --cpus-per-task=32 launch_BigGAN_bs512x4.sh
...
--dataset NF1_hdf5 --parallel --shuffle --num_workers 16 --batch_size 136 --load_in_mem  \
